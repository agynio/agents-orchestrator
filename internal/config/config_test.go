...
func TestFromEnvDefaultsNonZiti(t *testing.T) {
	...
	if cfg.ZitiSidecarImage != "ghcr.io/agynio/agents-orchestrator:ziti-tunnel-2.0.0-x509.1" {
		t.Fatalf("expected ziti sidecar image %q, got %q", "ghcr.io/agynio/agents-orchestrator:ziti-tunnel-2.0.0-x509.1", cfg.ZitiSidecarImage)
	}
